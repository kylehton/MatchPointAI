...
export default function TennisPredictionApp() {
  ...
  const scrollToInput = () => {
    setScrollLocked(false) // Unlock scroll when button is clicked
                  ...
                  <div>
                    ...
                    <Select value={player1} onValueChange={setPlayer1}>
                      <SelectTrigger className="mt-2 bg-white/10 border-white/20 text-white">
                        <SelectValue placeholder="Choose player 1" />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select value={surface} onValueChange={setSurface}>
                      ...
                      <SelectContent className="bg-white text-black">
                        <SelectItem value="Hard" className="hover:bg-gray-100">Hard Court</SelectItem>
                        <SelectItem value="Clay" className="hover:bg-gray-100">Clay Court</SelectItem>
                        <SelectItem value="Grass" className="hover:bg-gray-100">Grass Court</SelectItem>
                    ...
                    <div className="mt-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                      ...
                      <div className="space-y-2">
                        ...
                        {predictionResult.probability && (
                          <p><strong>Win Probability:</strong> {(predictionResult.probability * 100).toFixed(1)}%</p>
                        )}
                      </div>
                    </div>
                  )}
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Select value={player2} onValueChange={setPlayer2}>
                      <SelectTrigger className="mt-2 bg-white/10 border-white/20 text-white">
                        <SelectValue placeholder="Choose player 2" />
                      </SelectTrigger>
                      <SelectContent className="bg-white text-black max-h-60">
                        {players.map((player) => (
                          <SelectItem key={player} value={player} className="hover:bg-gray-100">
